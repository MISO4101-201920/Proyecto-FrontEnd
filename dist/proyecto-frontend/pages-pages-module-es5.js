(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-pages-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesLoadVideoLoadVideoComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesLoadVideoLoadVideoComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "LoadVideoComponent", function () {
      return LoadVideoComponent;
    });
    /* harmony import */
    ...
    var _services_contenidoInter_load_video_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    var LoadVideoComponent =
    /*#__PURE__*/
    function () {
      function LoadVideoComponent(fb, _loadVideoService) {
      ...
      var _proto = LoadVideoComponent.prototype;

      _proto.ngOnInit = function ngOnInit() {};

      _proto.guardarVideo = function guardarVideo(n, v) {
        this.loadVideo.url = v.value;
        this.loadVideo.nombre = n.value; // this.loadVideo.url = "https://www.youtube.com/watch?v=3JuYkJyJh7c";
        // this.loadVideo.nombre = "Entender a Supergirl";
        // this.loadVideo.cursos_seleccionados = [{ "id": 1 }];

        this._loadVideoService.loadUrl(this.loadVideo).subscribe(function (result) {
          console.log(result);
        }, function (error) {
          console.log(error);
          sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a.fire('Oops...', 'revisa los datos ingresados', 'error');
        }, function () {
          sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a.fire('Cargado!', 'Tu video ha sido cargado con Exito a contenido interactivo.', 'success'); // this.router.navigate(['/']);
        });
      };
    ...
    LoadVideoComponent.ctorParameters = function () {
      return [{
    ...
    LoadVideoComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-load-video',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./load-video.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/loadVideo/load-video.component.html")).default,
  ...
  function srcAppPagesPagesModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _loadVideo_load_video_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./loadVideo/load-video.component */
    "./src/app/pages/loadVideo/load-video.component.ts"); //Components of Pages


    var routes = [{
      path: '',
      component: _loadVideo_load_video_component__WEBPACK_IMPORTED_MODULE_5__["LoadVideoComponent"]
    }];
    ...
    PagesModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_loadVideo_load_video_component__WEBPACK_IMPORTED_MODULE_5__["LoadVideoComponent"]],
      imports: [_material_module__WEBPACK_IMPORTED_MODULE_4__["MaterialModule"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forChild(routes)],
